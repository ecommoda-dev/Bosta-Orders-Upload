...
//   · الاستبدال زي ما هو — نقلة `Ready` لسه بتحصل عند الطباعة.
//   · `printing_time_s2` **لسه مابيتكتبش** في أي وضع.
...
// ⚠️ **ولازم تتراجع أي بوابة طباعة S2** بتقرا `status_2_r_e = Confirmed + RETURN`:
//    الأوردر بقى `In-Return` قبل ما البوليصة تتطبع.
//
...
//    لوحده**. الاستبدال لسه على القاعدة: نقلة `Ready` بتحصل عند الطباعة.
//    ⚠️ `printing_time_s2` **لسه مابيتكتبش** في التلات أوضاع — ده وقت طباعة،
//    وكتابته وقت الرفع بتخلي أي تقرير مبني عليه يقول إن البوليصة اتطبعت وهي لأ.
