...
//    الصف الموقوف مش المرفوع بيقول «لم يتم الرفع» زي أي صف تاني مش مرفوع.
//    المنع نفسه (`rowUploadable`) هو اللي فرّق بينهم فوق، مش البادج ده.
chk('وحالة الرفع «لم يتم الرفع» (زي أي صف مش مرفوع)', api.rowUpLabel(cov), 'لم يتم الرفع');
...
chk('وحالة الرفع لسه «لم يتم الرفع» (لسه مش مرفوع)', api.rowUpLabel(cov), 'لم يتم الرفع');
...
//    يعني الصف يبان «لم يتم الرفع» وهو مرفوع فعلًا بشحنة بفلوس. وبادج
...
chk('وصف موقوف مش مرفوع «لم يتم الرفع»', api.rowUpState(rows[3]),    'notUploaded');
chk('وصف سليم مش مرفوع «لم يتم الرفع» برضه', api.rowUpState(rows[0]), 'notUploaded');
