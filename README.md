...
| **⚠ تم جزئيًا** | الشحنة **موجودة فعلًا** على بوسطة، بس حاجة بعدها ما تمّتش. 🔴 **متعيدش الرفع** — هتعمل شحنة مكررة بفلوس حقيقية. الحل: تصحيح يدوي، أو **✕ إلغاء الشحنة** من جدول النتايج وبعدين رفع مصحّح |
